...
(function() {
  ...
  function getCurrentTheme() {
    ...
    return savedTheme && Object.values(THEMES).includes(savedTheme) ? savedTheme : DEFAULT_THEME;
  }
  ...
  function applyTheme(theme) {
    ...
    if (themeToggle) {
      themeToggle.title = `Switch to ${theme === THEMES.light ? 'dark' : 'light'} theme`;
    }
  }
  ...
  function initTheme() {
    ...
    if (nav) {
      ...
      themeToggleLi.innerHTML = THEME_TOGGLE_HTML;
