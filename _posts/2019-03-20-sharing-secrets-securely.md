...
4. [GnuPG](#4-gnupg)
   1. [Troubleshooting: GnuPG Non-ASCII User Identifier](#troubleshooting-gnupg-non-ascii-user-identifier)
   2. [Bonus 1: GnuPG key management](#bonus-1-gnupg-key-management)
   3. [Bonus 2: GnuPG signing](#bonus-2-gnupg-signing)
   4. [Bonus 3: GnuPG public key verification & _web of trust_](#bonus-3-gnupg-public-key-verification--web-of-trust)
